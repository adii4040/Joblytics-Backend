...
import { sendMail, emailVerificationMailGen, forgotPasswordReqMailGen } from '../utils/Mail.utils.js'
...
const updateUser = asyncHandler(async (req, res) => {
    ...
    if (!username && !fullname && !email && !req.file) throw new ApiError(400, "Atleast one field is required to update!!")
